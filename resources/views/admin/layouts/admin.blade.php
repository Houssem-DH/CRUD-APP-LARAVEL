...
<head>
    ...
    <base href="{{ URL::asset('/dashboard') }}" target="_top">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/dashboard/members"
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/dashboard/pending-posts"
                                aria-expanded="false"><i class="mdi mdi-receipt"></i><span
                                    class="hide-menu">Pending Posts</span></a>
                        </li>
